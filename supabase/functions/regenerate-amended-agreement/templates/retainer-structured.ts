// Structured retainer contract template — Local Surge "Work For Free
// Until We Do" 90-day retainer. Source: Ben's paste 2026-05-25.
//
// Diff from trial.js (kept side-by-side rather than DRY'd because legal
// docs benefit from being self-contained per template):
//   - 90 days instead of 14
//   - Services list includes Backlink Building
//   - Clause 4 is GUARANTEE (top-3 ranking + DBA + photos + reviews)
//     instead of CONTINUATION OF PROJECT
//   - Clause 7.2 is DIRECT DEBIT (shorter than trial's PAYMENT AUTHORITY)
//   - No clause 16.5 CANCELLATION NOTICE (trial-only)
//   - Clause 4 reference in clause 13 still works (both have a clause 4)

export const RETAINER_TEMPLATE = {
  id: 'retainer',
  contractType: 'retainer',
  title: 'Local Surge — Work For Free Until We Do (90-day retainer)',
  ...
  clauses: [
    // Clauses 1, 2, 3 are identical to trial — kept inline for self-containment.
    {
    ...
    // Clause 4 — RETAINER-SPECIFIC: GUARANTEE
    {
      id: '4', number: '4', title: 'GUARANTEE',
      paragraphs: [
        { label: '(a)', text: 'Subject to clause 4(b), Opt Digital Limited guarantees that the Client will receive top 3 ranking on google maps for one of their 3 target keywords within a 90 day period (Guarantee). If this is not met, Opt Digital will honor their money back guarantee.' },
        { label: '(b)', text: 'To be eligible for this continued service, the Client must:', children: [
          { label: '(i)', text: 'Create a DBA with the name Opt Digital Instructions' },
          { label: '(ii)', text: 'Not alter primary service locations or primary targeted services' },
          { label: '(iii)', text: 'Provide 10 new photos per month' },
          { label: '(iv)', text: 'Provide requested information within 5 business days' },
          { label: '(v)', text: 'Generate 2 reviews weekly outside of Opt Digital’s OTO review blasts' },
        ] },
        { label: '(c)', text: 'If the Client meets all conditions but does not receive top 3 ranking on google maps for one of their target keywords within a 90 day period, however is seeing positive movements, Opt Digital Limited will continue to deliver services for up to 30 additional days at no further cost. During this time, the Client must remain actively engaged and uphold all obligations.' },
        { label: '(d)', text: 'If the Guarantee is still not achieved after the additional service period, both parties may agree to:', children: [
          { label: '(i)', text: 'Continue working together under a mutually agreed retainer; or' },
          { label: '(ii)', text: 'End the working relationship, with no further obligation on either side.' },
        ] },
      ],
    },
    // Clauses 5, 6 — same as trial
    {
    ...
    },
    {
      ...
      sections: [
        { id: '6.1', number: '6.1', title: 'CLIENT MATERIALS', paragraphs: [
        ...
        { id: '6.2', number: '6.2', title: 'RELEASE', paragraphs: [
    ...
    // Clause 7 — RETAINER-SPECIFIC 7.2 (DIRECT DEBIT, simpler than trial's PAYMENT AUTHORITY)
    {
      id: '7', number: '7', title: 'PAYMENT',
      sections: [
        { id: '7.1', number: '7.1', title: 'FEES', paragraphs: [
        ...
        {
          id: '7.2', number: '7.2', title: 'DIRECT DEBIT',
          intro: 'If the Client is paying by direct debit, the Client:',
          paragraphs: [
            { label: '(a)', text: 'agrees to enter into a Direct Debit Service Agreement and a Direct Debit Request Form with Stripe that we provide to the Client;' },
            { label: '(b)', text: 'authorises Opt Digital Limited to charge the Client’s bank account in advance in line with the Client Form and DDR Service Agreement;' },
            { label: '(c)', text: 'acknowledges and agrees that each direct debit payment will incur a $1.25 or 2.9%, whichever is greater, for Visa and MasterCard;' },
            { label: '(d)', text: 'must ensure that there are sufficient funds available in their account to allow Stripe to debit the Fees payable;' },
            { label: '(e)', text: 'must give Opt Digital Limited a notice of at least 48 hours if:', children: [
              { label: '(i)', text: 'the Client is transferring or closing the account specified in their DDR;' },
              { label: '(ii)', text: 'there are any changes to the Client’s credit card specified in their DDR; and' },
            ] },
            { label: '(f)', text: 'acknowledges and agrees that if a debit is returned by the Client’s financial institution as ‘unpaid’:', children: [
              { label: '(i)', text: 'Opt Digital Limited will charge the Client a $7 dishonour fee in addition to any fees charged under the DDR Service Agreement by Stripe; and' },
              { label: '(ii)', text: 'Opt Digital Limited will suspend access to the Services until the amounts payable are received by Opt Digital Limited.' },
            ] },
          ],
        },
        { id: '7.3', number: '7.3', title: 'TIME FOR PAYMENT', intro: 'Unless otherwise agreed in the Client Form or in writing:', paragraphs: [
        ...
        { id: '7.4', number: '7.4', title: 'PAYMENT METHOD', paragraphs: [
          { text: 'The Client must pay Fees using the fee payment method specified in the Client Form.' },
        ] },
        { id: '7.5', number: '7.5', title: 'ONLINE PAYMENT PARTNER', paragraphs: [
        ...
        { id: '7.6', number: '7.6', title: 'LATE PAYMENT', intro: 'If the Client does not pay an amount due under this Agreement on or before the date it is due:', paragraphs: [
        ...
        { id: '7.7', number: '7.7', title: 'GST', paragraphs: [
    ...
    },
    {
      ...
      sections: [
        { id: '12.1', number: '12.1', title: 'CLIENT CONTENT', paragraphs: [
        ...
        { id: '12.2', number: '12.2', title: 'DEVELOPED IP', paragraphs: [
        ...
        { id: '12.3', number: '12.3', title: 'CONSULTANT IP', paragraphs: [
        ...
        { id: '12.4', number: '12.4', title: 'DEFINITIONS', intro: 'For the purposes of this Agreement:', paragraphs: [
    ...
    // Clause 16 — no 16.5 in retainer (trial-only)
    {
      id: '16', number: '16', title: 'TERMINATION',
      sections: [
        { id: '16.1', number: '16.1', title: 'TERMINATION BY OPT DIGITAL LIMITED', intro: 'Opt Digital Limited may terminate this Agreement in whole or in part immediately by written notice to the Client if:', paragraphs: [
        ...
        { id: '16.2', number: '16.2', title: 'TERMINATION BY THE CLIENT', intro: 'The Client may terminate this Agreement in whole or in part by written notice to Opt Digital Limited if Opt Digital Limited:', paragraphs: [
        ...
        { id: '16.3', number: '16.3', title: 'EFFECT OF TERMINATION', intro: 'Upon termination of this Agreement, the Client must promptly pay (at Opt Digital Limited’s request):', paragraphs: [
        ...
        { id: '16.4', number: '16.4', title: 'SURVIVAL', paragraphs: [
...
export default RETAINER_TEMPLATE
