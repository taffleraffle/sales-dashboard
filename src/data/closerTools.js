/* The closer's apps, in the order of a working day. Kept to what a closer
   ...
   `shared` names the credential pair the backend holds, nothing is written here. `chip` is the
...
export const CLOSER_TOOLS = [
  ...
  { key: 'semrush', chip: 'S', name: 'Semrush', url: 'https://www.semrush.com/multilogin/?redirect_to=%2F', what: 'The prospect audit.', shared: 'semrush' },
  { key: 'lbm', chip: 'LB', name: 'Local Brand Manager', url: 'https://app.localbrandmanager.com/sign_in', what: 'Map-pack heatmap for the pitch.', shared: 'lbm' },
