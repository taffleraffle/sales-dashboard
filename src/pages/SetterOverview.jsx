...
export default function SetterOverview() {
  ...
  // Company-level from EOD aggregation
  ...
  const company = {
    totalDials: companyFromEOD.outboundCalls,
    totalLeadsCalled: companyFromEOD.totalLeads,
    mcs: companyFromEOD.mcs,
    sets: companyFromEOD.sets,
    pickupRate: companyFromEOD.outboundCalls ? ((companyFromEOD.pickups / companyFromEOD.outboundCalls) * 100).toFixed(1) : 0,
    dialsPerSet: companyFromEOD.sets ? (companyFromEOD.outboundCalls / companyFromEOD.sets).toFixed(1) : 0,
  }
