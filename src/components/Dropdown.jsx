    ...
    <div className="flex flex-col gap-1" ref={wrap} style={{ width }}>
      ...
      <div className="relative">
        <button
          ...
          aria-expanded={open}
          className="house-plain w-full flex items-center justify-between gap-2 text-sm text-left"
          style={{
            height: 40, padding: '0 14px', borderRadius: 14, fontWeight: 500,
            border: `1px solid ${open ? 'var(--accent)' : 'var(--house-line-strong)'}`,
            boxShadow: open ? '0 0 0 4px var(--house-ring)' : 'var(--house-shadow-input)',
            background: '#ffffff',
        ...
        {open && (
          <ul
            ...
            style={{
              zIndex: 40, background: '#ffffff', border: '1px solid var(--rule)', borderRadius: 16, padding: 6,
              boxShadow: '0 18px 44px -20px rgba(20,22,30,.35)',
            ...
            {options.map((o, i) => {
              ...
              return (
                <li key={o.value ?? i}
                  ...
                  style={{ cursor: 'pointer', padding: '9px 12px', borderRadius: 10, fontWeight: 500, background: isActive ? 'rgba(244,225,74,.18)' : 'transparent' }}>
